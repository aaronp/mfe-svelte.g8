...
git.remoteRepo := s"git@github.com:$username/foo.git"
...
// https://coveralls.io/github/aaronp/foo
// https://github.com/scoverage/sbt-coveralls#specifying-your-repo-token
coverallsTokenFile := Option((Path.userHome / ".sbt" / ".coveralls.foo").asPath.toString)

buildInfoKeys := Seq[BuildInfoKey](name, version, scalaVersion, sbtVersion)
buildInfoPackage := "bar.build"
